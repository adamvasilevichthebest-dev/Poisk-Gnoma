...
function trials_cond_leftLoopBegin(trials_cond_leftLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trials_cond_left.forEach(function() {
...
function hand_change_rightRoutineBegin(snapshot) {
  return async function () {
    ...
    hand_change_rightComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials_rightRoutineBegin(snapshot) {
  return async function () {
    ...
    trials_rightComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function hand_change_leftRoutineBegin(snapshot) {
  return async function () {
    ...
    hand_change_leftComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials_leftRoutineBegin(snapshot) {
  return async function () {
    ...
    trials_leftComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
